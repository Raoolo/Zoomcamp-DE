...
os.system(f'wget -O green_taxi.parquet https://d37ci6vzurychx.cloudfront.net/trip-data/green_tripdata_2019-01.parquet')
...
# MI SONO FERMATO A CREARE UN POSTGRESQL IMAGE